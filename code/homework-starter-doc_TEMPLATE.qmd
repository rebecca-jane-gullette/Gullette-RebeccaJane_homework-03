...
**SLA doesn't really affect total mass? check correlation, compare evidence (visual and statistical) - ~.45 correlation so moderate**
...
1. **total mass is predicted by species, water treatment, and SLA**  
...
Out of the four models we have tried, the best model is the one that includes **all three predictors (species, water treatment, and sla)**  

Note that this may change once you fit and compare the other model! - IT DID!!
...
**reference for water_treatment:** **water_treatment drought stressed**  
**reference for species_name:** **species_nameAcmispon glaber**  

Interpret the model estimates for the:  

- intercept: **0.08, mass of Acmispon glaber in drought stressed treatment when SLA = 0**  
- SLA slope: **-0.0002475, across drought treatments and species, with each 1 unit increase in SLA (mm^2^/dry mass of leaf), we expect an increase in total mass of -0.00025 WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THERE IS NO EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **0.12 ± 0.02 -> across all species and SLA, well watered plants tend to be 0.12 ± 0.02 grams more massive than drought stressed plants **    
